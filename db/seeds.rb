...
resistors_list.each do |amount, value|
  Component.create!(component_type: component_types_list[0], value: value )
...
capacitors_list.each do |amount, value|
  Component.create!(component_type: component_types_list[1], value: value )
  component_id = Component.last.id
  ComponentsProject.create!(project_id: 1, amount: amount, component_id: component_id )
end
...
ics_list.each do |amount, legs, value|
  Component.create!(component_type: component_types_list[2], legs: legs, model: value )
  component_id = Component.last.id
  ComponentsProject.create!(project_id: 1, amount: amount, component_id: component_id )
end
...
transistors_list.each do |amount, value|
  Component.create!(component_type: component_types_list[3], model: value )
  component_id = Component.last.id
  ComponentsProject.create!(project_id: 1, amount: amount, component_id: component_id )
end
...
potentiometers_list.each do |amount, value, log, rev|
  Component.create!(component_type: component_types_list[5], value: value, log: log, rev: rev )
  component_id = Component.last.id
  ComponentsProject.create!(project_id: 1, amount: amount, component_id: component_id )
end
...
swdcjacks_list.each do |id, amount, model|
  Component.create!(component_type: component_types_list[id], model: model )
  component_id = Component.last.id
  ComponentsProject.create!(project_id: 1, amount: amount, component_id: component_id )
end
...
sockets_list.each do |amount, legs, model|
  Component.create!(component_type: component_types_list[8], legs: legs, model: model )
  component_id = Component.last.id
  ComponentsProject.create!(project_id: 1, amount: amount, component_id: component_id )
end
